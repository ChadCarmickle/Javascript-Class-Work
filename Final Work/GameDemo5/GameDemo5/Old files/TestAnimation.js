...
function spawnPoke2(frameCheck) { 

var Pokemon2 = new Array(); 

for(let i = 0; i < 4; i++) {
Pokemon2[i] = new Image(); 
Pokemon2[i].src = "pokemon2_frame" + i + ".PNG";

}

return Pokemon2[frameCheck]; 
...
//Character_x_velocity *= 0.9;// friction
	...
	var Mob = new testObject2(Mob_x, Mob_y, MoveMob()); 
		...
		var TestMob = new testObject2(Mob_x, Mob_y, MoveMob()); 
		TestMob.display(); 
